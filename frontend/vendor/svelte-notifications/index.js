(function (global, factory) {
    ...
    (global = global || self, global.Notifications = factory());
    ...
    /* src/Notifications.svelte generated by Svelte v3.12.1 */
    const { document: document_1 } = globals;

    function add_css() {
    	var style = element("style");
    	style.id = 'svelte-1ggskci-style';
    	style.textContent = ".toasts{list-style:none;position:fixed;top:0;right:0;padding:0;margin:0;z-index:9999}.toasts>.toast{position:relative;margin:10px;min-width:40vw;position:relative;animation:svelte-1ggskci-animate-in 350ms forwards;color:#fff}.toasts>.toast>.content{padding:10px;display:block;font-weight:500}.toasts>.toast>.progress{position:absolute;bottom:0;background-color:rgb(0, 0, 0, 0.3);height:6px;width:100%;animation-name:svelte-1ggskci-shrink;animation-timing-function:linear;animation-fill-mode:forwards}.toasts>.toast:before,.toasts>.toast:after{content:\"\";position:absolute;z-index:-1;top:50%;bottom:0;left:10px;right:10px;border-radius:100px / 10px}.toasts>.toast:after{right:10px;left:auto;transform:skew(8deg) rotate(3deg)}@keyframes svelte-1ggskci-animate-in{0%{width:0;opacity:0;transform:scale(1.15) translateY(20px)}100%{width:40vw;opacity:1;transform:scale(1) translateY(0)}}@keyframes svelte-1ggskci-shrink{0%{width:40vw}100%{width:0}}";
    ...
    function instance($$self, $$props, $$invalidate) {
      ...
      onDestroy(unsubscribe);
    	...
    	$$self.$set = $$props => {
    		if ('themes' in $$props) $$invalidate('themes', themes = $$props.themes);
    ...
    class Notifications extends SvelteComponent {
    	constructor(options) {
    		super();
    		if (!document_1.getElementById("svelte-1ggskci-style")) add_css();
    		init(this, options, instance, create_fragment, safe_not_equal, ["themes", "timeout"]);
    	}
    }
